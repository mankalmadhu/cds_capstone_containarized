...
from stream_predictor import run_stream
...
def build_arg_parser():
    ...
    parser.add_argument("--ops",
                        ...
                        choices=[
                            ...
                            'model_train', 'model_test', 'stream_predict'
                        ])
...
def run_feature_extract():
    ...
    feature_pipline_model, feature_df = extract_features(
        cleaned_df.limit(10000))

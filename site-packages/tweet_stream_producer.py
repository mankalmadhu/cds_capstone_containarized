...
if __name__ == "__main__":
    ...
    load_dotenv()
    while True:
        search_words = "COVID19 OR COVID-19 OR coronavirus OR coronavaccine OR coronaoutbreak -filter:retweets"
        date_since = "2021-12-29"
        tweets_cursor = build_tweet_search_cursor(search_words, date_since)
        tweet_list = build_filtered_json_list(tweets_cursor.items(5))
        if tweet_list:

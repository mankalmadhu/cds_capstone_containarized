...
from ml_boms import (FetchDataModel, Operations, FeatureColumns, TaskBaseModel,
                     ...
                     PipelinePathConfig, StreamPredictModel)
...
def run_train():
    ...
    if train_model.save:
        write_pipeline(
            model,
            os.path.join(pipeline_paths.trained_model_pipeline,
                         train_model.ml_model.name))
...
def run_stream_predictor():
    task_model = StreamPredictModel.parse_raw(args.params)

import tweepy
import sys
from ml_boms import TwitterCreds
...
def build_twitter_api_object():
    ...
    twitter_creds = TwitterCreds.get_twiiter_creds()

    auth = tweepy.OAuthHandler(twitter_creds.twitter_consumer_key,
                               twitter_creds.twitter_consumer_secret)
    auth.set_access_token(twitter_creds.twitter_access_key,
